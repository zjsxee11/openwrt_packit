...
PLATFORM=rockchip
SOC=rk3399  #本次变更：型号改为3399
BOARD=TN3399  #本次变更：型号改为TN3399
SUBVER=$1
...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3399/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3399"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3399/btld-rk3399.bin"
...
ln -sf ./dtb-${KERNEL_VERSION}/rockchip/tn3399_wifi_bt_fix.dtb .
...
extraboardargs=
fdtfile=/dtb/rockchip/tn3399_wifi_bt_fix.dtb
EOF
echo "armbianEnv.txt -->"
echo "==============================================================================="
cat armbianEnv.txt
